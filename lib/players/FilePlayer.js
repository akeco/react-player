  ...
  _createClass(FilePlayer, [{
    ...
    value: function load(url) {
      ...
      var _this$props$config$fi = this.props.config.file,
          ...
          drm = _this$props$config$fi.drm,
          forceSHAKA = _this$props$config$fi.forceSHAKA;
      ...
      if (this.shouldUseHLS(url)) {
        (0, _utils.getSDK)(HLS_SDK_URL.replace('VERSION', hlsVersion), HLS_GLOBAL).then(function (Hls) {
          ...
          if (setPrometheanTv) setPrometheanTv('hls', _this2.hls);
        });
      }
      ...
      if (this.shouldUseDASH(url)) {
        if (forceSHAKA) {
          ...
          (0, _utils.getSDK)(DASH_SDK_URL.replace('VERSION', dashVersion), DASH_GLOBAL).then(function (dashjs) {
            ...
            if (Object.keys(drm).length) {
              _this2.dash.setProtectionData(_defineProperty({}, keys[0], drm.servers[keys[0]]));
